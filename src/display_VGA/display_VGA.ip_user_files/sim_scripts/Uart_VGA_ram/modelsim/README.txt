...
#
# Generated by export_simulation on Sun Jan 06 12:29:46 +0800 2019
#
################################################################################
...
switch to the './Uart_VGA_ram.sh' script.

./Uart_VGA_ram.sh -reset_run
...
./Uart_VGA_ram.sh -noclean_files

For more information on the script, please type './Uart_VGA_ram.sh -help'.
