...
HD_PWD='D:/FPGA/display_VGA/display_VGA.runs/blk_mem_VGA_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_VGA.vds -m64 -mode batch -messageDb vivado.pb -notrace -source blk_mem_VGA.tcl
