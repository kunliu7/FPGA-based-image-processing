...
HD_PWD='D:/FPGA/display_VGA/display_VGA.runs/shift_ram_3x3_1bit_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_ram_3x3_1bit.vds -m64 -mode batch -messageDb vivado.pb -notrace -source shift_ram_3x3_1bit.tcl
