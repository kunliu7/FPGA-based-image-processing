...
HD_PWD='D:/FPGA/display_VGA/display_VGA.runs/Uart_VGA_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Uart_VGA_ram.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Uart_VGA_ram.tcl
